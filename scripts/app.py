...
# ---------- Header Section ----------
st.markdown("""
    <h1 style='text-align: center; color: #FFB400;'>🩺 AI Disease Predictor</h1>
    <p style='text-align: center; color: #00B8D9;'>Get possible disease predictions based on your symptoms using Machine Learning.</p>
    <hr>
